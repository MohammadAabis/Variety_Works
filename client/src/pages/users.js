...
const Users = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if(!formData.first_name || !formData.last_name || !formData.email || !formData.phone || !formData.address || !formData.password || !formData.confirmPassword){
    ...
    return (
        <div className="signup"> 
            <form className="signup-content"> 
                ...
                <button onClick={handleSubmit} type="submit" className="signup-button" > Sign Up </button> 
                {message && 
                <div> 
